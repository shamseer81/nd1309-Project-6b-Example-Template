...
contract('SupplyChain', function (accounts) {
    ...
    it("Testing smart contract function processItem() that allows a farmer to process coffee", async () => {
        ...
        var resultAfterProcess = await supplyChain.processItem(upc, { from: originFarmerID });
        ...
        assert.equal(resultAfterProcess.logs[0].event, 'Processed')
    ...
    it("Testing smart contract function packItem() that allows a farmer to pack coffee", async () => {
        ...
        var resultAfterPack = await supplyChain.packItem(upc, { from: originFarmerID });
        ...
        assert.equal(resultAfterPack.logs[0].event, 'Packed')
    ...
    it("Testing smart contract function sellItem() that allows a farmer to sell coffee", async () => {
        ...
        var resultAfterSell = await supplyChain.sellItem(upc, productPrice, { from: originFarmerID });
        ...
        assert.equal(resultAfterSell.logs[0].event, 'ForSale')
    ...
    it("Testing smart contract function buyItem() that allows a distributor to buy coffee", async () => {
        ...
        var resultAfterBuy = await supplyChain.buyItem(upc, { from: distributorID, value: productPrice });
        // Retrieve the just now saved item from blockchain by calling function fetchItem()
        ...
        assert.equal(resultAfterBuy.logs[0].event, 'Sold')
    ...
    it("Testing smart contract function shipItem() that allows a distributor to ship coffee", async () => {
        ...
        var resultAfterShip = await supplyChain.shipItem(upc, { from: distributorID });
        ...
        assert.equal(resultBufferTwo[6], distributorID, 'Error: Invalid distributorID');
        assert.equal(resultAfterShip.logs[0].event, 'Shipped')
    ...
    it("Testing smart contract function receiveItem() that allows a retailer to mark coffee received", async () => {
        ...
        var resultAfterReceive= await supplyChain.receiveItem(upc, { from: retailerID });
        ...
        assert.equal(resultAfterReceive.logs[0].event, 'Received')
    ...
    it("Testing smart contract function purchaseItem() that allows a consumer to purchase coffee", async () => {
        ...
        var resultAfterPurchase= await supplyChain.purchaseItem(upc, { from: consumerID });
        ...
        assert.equal(resultAfterPurchase.logs[0].event, 'Purchased')
